# -*- coding: utf-8 -*-
#
# AIMBAT documentation build configuration file, created by
...
texinfo_documents = [
  ('index', 'AIMBAT', u'AIMBAT Documentation',
   u'Lay Kuan Loh, Xiaoting Lou, \& Suzan van der Lee', 'AIMBAT', 'One line description of project.',
   'Miscellaneous'),
]
